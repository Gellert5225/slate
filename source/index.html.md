...
Welcome to the Bytes & Bots documentation! You can use this document as a refrence to data models, REST routes cloud functions. 
...
Our server is deployed on Heroku, to run the server locally, clone the GitHub repo, and go to the folder "server". From there you can run the Node command
...
to run the server, which will be available at localhost:1337.
